...
while True:
    ...
    input_number_played = pyip.inputInt(
        min=1,
    ...
    input_minutes = pyip.inputInt(
        min=0, max=59, prompt='number of minutes: >>>')
    ...
    print(
        "---This video or song has been played for", round(
            ...
            time_in_weeks, 2), "weeks or", round(
                time_in_days, 2), "days or", round(
                    time_in_hours, 2), "hours or", round(
                        time_in_minutes, 2), "minutes or", round(
                            time_in_seconds, 2), "seconds.---")
